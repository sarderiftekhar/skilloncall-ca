...
return [
    ...
    'employer.success.title' => 'Bienvenue!',
    'employer.success.message' => 'Votre profil a été complété avec succès.',
    'employer.errors.validation_title' => 'Erreur de validation',
    'employer.errors.validation_message' => 'Veuillez corriger les erreurs suivantes:',
    'employer.errors.completion_title' => 'Impossible de terminer',
    'employer.errors.completion_message' => 'Veuillez corriger les éléments suivants:',

    // Employer Step 1: Business Information
    'employer.steps.business_info.title' => 'Informations sur l\'entreprise',
    'employer.steps.business_info.mobile' => 'Info entreprise',
    'employer.steps.business_info.description' => 'Nom et coordonnées de l\'entreprise',
    'employer.steps.business_info.welcome_title' => 'Bienvenue sur SkillOnCall!',
    'employer.steps.business_info.welcome_subtitle' => 'Commençons par configurer votre profil d\'entreprise.',
    'employer.steps.business_info.business_name' => 'Nom de l\'entreprise',
    'employer.steps.business_info.business_name_placeholder' => 'Entrez le nom de votre entreprise',
    'employer.steps.business_info.company_number' => 'Numéro d\'entreprise',
    'employer.steps.business_info.company_number_placeholder' => 'Entrez le numéro d\'enregistrement de l\'entreprise',
    'employer.steps.business_info.company_number_helper' => 'Numéro d\'enregistrement de l\'entreprise (max 30 caractères)',
    'employer.steps.business_info.phone' => 'Numéro de téléphone',
    'employer.steps.business_info.phone_helper' => 'Les travailleurs utiliseront ce numéro pour vous contacter',
    'employer.steps.business_info.industry' => 'Type d\'industrie',
    'employer.steps.business_info.optional' => 'Optionnel',
    'employer.steps.business_info.industry_placeholder' => 'Sélectionnez l\'industrie (optionnel)',
    'employer.steps.business_info.description' => 'Description de l\'entreprise (Optionnel)',
    'employer.steps.business_info.description_helper' => 'Parlez aux travailleurs de votre entreprise',
    'employer.steps.business_info.description_placeholder' => 'Décrivez brièvement votre entreprise...',

    // Employer Step 2: Location
    'employer.steps.location.title' => 'Emplacement',
    'employer.steps.location.mobile' => 'Emplacement',
    'employer.steps.location.description' => 'Adresse de l\'entreprise',
    'employer.steps.location.welcome_title' => 'Emplacement de l\'entreprise',
    'employer.steps.location.welcome_subtitle' => 'Cela aide les travailleurs à trouver des emplois dans leur région.',
    'employer.steps.location.address_title' => 'Adresse de l\'entreprise',
    'employer.steps.location.address_subtitle' => 'Cela aide les travailleurs à trouver des emplois près de votre entreprise',
    'employer.steps.location.street' => 'Adresse',
    'employer.steps.location.street_placeholder' => '123 Rue Principale',
    'employer.steps.location.unit' => 'Appartement/Unité (Optionnel)',
    'employer.steps.location.unit_placeholder' => 'Suite 200, Unité 101, etc.',
    'employer.steps.location.province' => 'Province',
    'employer.steps.location.province_placeholder' => 'Sélectionner',
    'employer.steps.location.city' => 'Ville',
    'employer.steps.location.city_placeholder' => 'Tapez pour rechercher des villes...',
    'employer.steps.location.city_placeholder_disabled' => 'Sélectionnez d\'abord une province',
    'employer.steps.location.loading_cities' => 'Chargement des villes...',
