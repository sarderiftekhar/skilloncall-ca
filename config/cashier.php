...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the table name used by Cashier Paddle for subscriptions.
    | We've renamed it to avoid conflict with existing subscriptions table.
    |
    */

    'subscription_table' => env('CASHIER_SUBSCRIPTION_TABLE', 'paddle_subscriptions'),
