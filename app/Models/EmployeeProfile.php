...
class EmployeeProfile extends Model
{
    ...
    {
        return $this->belongsToMany(GlobalSkill::class, 'employee_skills')
    ...
    {
        return $this->belongsToMany(GlobalLanguage::class, 'employee_languages')
    ...
    {
        return $this->hasMany(WorkExperience::class, 'employee_profile_id');
    }

    public function serviceAreas(): HasMany
    {
        return $this->hasMany(EmployeeServiceArea::class);
    }
