...
class EmployerReviewController extends Controller
{
    ...
    /**
     * Display a listing of reviews for the authenticated employer.
     */
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('employer/reviews/index', [
            'reviews' => $reviews,
            'stats' => $stats,
    ...
    public function create(Application $application): Response
    {
        ...
        return Inertia::render('employer/reviews/create', [
    ...
    public function edit(Review $review): Response
    {
        ...
        return Inertia::render('employer/reviews/edit', [
